...
#ifndef EXPO_PANORAMA_VIEW_EXAMPLE_LINKEDBLOCKINGQUEUE_H
#define EXPO_PANORAMA_VIEW_EXAMPLE_LINKEDBLOCKINGQUEUE_H
...
#endif //EXPO_PANORAMA_VIEW_EXAMPLE_LINKEDBLOCKINGQUEUE_H
