...
#ifndef EXPO_PANORAMA_VIEW_EXAMPLE_OPENGLESPLAYER2_H
#define EXPO_PANORAMA_VIEW_EXAMPLE_OPENGLESPLAYER2_H
...
#endif //EXPO_PANORAMA_VIEW_EXAMPLE_OPENGLESPLAYER2_H
